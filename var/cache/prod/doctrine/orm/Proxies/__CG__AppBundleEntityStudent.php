...
class Student extends \AppBundle\Entity\Student implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'student_id', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'session_id', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'reg_no', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'surname', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'othername', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'firstname', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'mobile', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'sex', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'mstatus', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'address', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'passport'];
        }
