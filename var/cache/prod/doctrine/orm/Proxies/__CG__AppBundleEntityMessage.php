...
class Message extends \AppBundle\Entity\Message implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'message_id', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'message_sender_id', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'message_content', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'message_date', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'message_reciever'];
        }
    ...
    public function setMessageReciever($messageReciever)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMessageReciever', [$messageReciever]);

        return parent::setMessageReciever($messageReciever);
    }
    ...
    public function getMessageReciever()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMessageReciever', []);

        return parent::getMessageReciever();
    }
