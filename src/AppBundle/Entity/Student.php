...
* @UniqueEntity(fields="reg_no", message="Student registration number already exists.")
...
class Student
{
    ...
    */
    ...
    /**
    * @ORM\Column(type="integer")
    * @Assert\NotBlank(groups={"add","edit"},message="Choose student session.")
    */
    private $session_id;
    ...
    * @ORM\Column(type="string")
     * @Assert\NotBlank(groups={"add","edit"}, message = "Choose student gender.")
    */
    private $sex;

    /**
    * @ORM\Column(type="string", length=100)
     * @Assert\NotBlank(groups={"add","edit"},message = "Choose student marital status.")
    */
    private $mstatus;
    ...
    */
    ...
    /**
    * @ORM\Column(type="string", length=100)
     * @Assert\NotBlank(groups={"add"}, message = "Upload student passport.")
