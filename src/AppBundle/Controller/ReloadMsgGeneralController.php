...
class ReloadMsgGeneralController extends Controller
{
    /**
     * @Route("/reload2", name="reload2")
     */
    public function indexAction(Request $request)
    {
        ...
        return $this->render("user/reload2.html.twig", array('form' => $form->createView(),'students'=>$student, 'user'=>$user, 'messages'=>$mes, "page_header"=>"General Blog", 'student'=>$stu, 'courses'=>$cour, 'session'=>$ses));
    }
}
