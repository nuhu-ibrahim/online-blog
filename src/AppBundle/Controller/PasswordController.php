...
class PasswordController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render("user/change_password.html.twig", array('success'=>$success, 'errors'=>$error, 'user'=>$user, 'form' => $form->createView(), 'news'=>$news,"page_header"=>"Password", 'student'=>$stu, 'courses'=>$cour, 'session'=>$ses));
