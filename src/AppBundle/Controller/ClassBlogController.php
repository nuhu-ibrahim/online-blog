...
class ClassBlogController extends Controller
{
    /**
     * @Route("/class_blog", name="class_blog")
     */
    public function indexAction(Request $request)
    {
        ...
        return $this->render("user/class_blog.html.twig", array('form' => $form->createView(), 'user'=>$user, 'messages'=>$mes, "page_header"=>"Class Blog", 'student'=>$stu, 'students'=>$student, 'courses'=>$cour, 'session'=>$ses));
    }
}
